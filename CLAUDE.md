...
## Status (2026-07-08)
- Pipeline is feature-complete: 60-symbol universe, 104 tests passing locally (107 incl.
  the 3 legacy BQ tests in test_ohlcv_daily.py that need GCP ADC), dry-run CSVs validated locally.

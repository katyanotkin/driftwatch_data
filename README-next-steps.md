...
Current state (2026-07-08): pipeline is feature-complete, 107 tests pass (104 without
...
- `tests/test_safe_converters.py`, `tests/test_fetch_ohlcv.py`, `tests/test_ohlcv_daily.py`
  — exercise `driftwatch/`, not `teamfish/`. They inflate the "107 tests" count with
  legacy coverage.

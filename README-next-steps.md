...
Current state (2026-07-08): pipeline is feature-complete, 103 tests pass (100 without
...
- `tests/test_safe_converters.py`, `tests/test_fetch_ohlcv.py`, `tests/test_ohlcv_daily.py`
  — exercise `driftwatch/`, not `teamfish/`. They inflate the "103 tests" count with
  legacy coverage.
